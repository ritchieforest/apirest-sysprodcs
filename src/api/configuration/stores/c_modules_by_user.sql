-- Active: 1695737047766@@127.0.0.1@1433@PRODUCTS@dbo

alter procedure c_modules_by_user --2,1
(
@user int,
@empresa int
)
...
sudum.sysuser03_baja,sudum.sysuser03_modificacion,sudum.sysuser03_listado,see.id_sysempr01 ,sum2.id_sysuser03 ,sum2.sysuser03_descripcion,sum2.sysuser03_url,sum2.sysuser03_icon,isnull(sum2.fk_sysuser03,0) fk_sysuser03,
'Exito' as TipeResult
