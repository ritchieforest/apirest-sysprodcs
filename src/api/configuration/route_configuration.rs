...
use crate::api::configuration::services::s_cuotas_tarjetas::{s_configempresas_a_sp,s_configempresas_b_sp,s_configempresas_l_sp,s_configempresas_m_sp};
...
pub fn config(cfg:&mut web::ServiceConfig){
    ...
    .route("api/configuration/listconfcuotas",web::post().to(s_configempresas_l_sp))
    .route("api/configuration/addconfigcuotas",web::post().to(s_configempresas_a_sp))
    .route("api/configuration/editconfigcuotas",web::post().to(s_configempresas_m_sp))
    .route("api/configuration/delteconfigcuotas",web::post().to(s_configempresas_b_sp));
