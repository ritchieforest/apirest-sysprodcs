...
pub async fn c_productos_a_sp(conexion:Arc<Mutex<Client<TcpStream>>>,
    data: Value
    ...
    sql_query.push_str("c_productos_abmlc_sp ");
...
pub async fn c_productos_m_sp(conexion:Arc<Mutex<Client<TcpStream>>>,
    data: Value
)-> Result<Value,AppError>{
...
pub async fn c_productos_b_sp(conexion:Arc<Mutex<Client<TcpStream>>>,
    data: Value
)-> Result<Value,AppError>{
...
pub async fn c_productos_l_sp(conexion:Arc<Mutex<Client<TcpStream>>>,
    data: Value
